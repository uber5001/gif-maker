function getUniverse() {
        ...
        if (!window.universe) {
              ...
              window.universe.addFrame("data:image/gif;base64,");
        }
...
function renderUniverse(onDone) {
		...
		img.setAttribute('src',frame.image);
                gif.addFrame(img, {delay: frame.duration/u.speed + 2000});
        }
